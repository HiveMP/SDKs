...
if ($OnlyVersion -eq "" -or $OnlyVersion -eq "5.4.1f") {
...
if ($OnlyVersion -eq "" -or $OnlyVersion -eq "2017.1.1f1") {
...
if ($OnlyVersion -eq "" -or $OnlyVersion -eq "2017.2.0f3") {
...
if ($OnlyVersion -eq "" -or $OnlyVersion -eq "2017.3.0f3") {
...
if ($OnlyVersion -eq "" -or $OnlyVersion -eq "2018.1.7f1") {
