...
Invoke-WebRequest -UseBasicParsing -Uri https://github.com/RedpointGames/UnityAutomaticLicensor/releases/download/0.3/UnityAutomaticLicensor.zip -OutFile C:\UnityAutomaticLicensor.zip
...
Write-Output "Running Unity licensing application for 2017.x and above..."
